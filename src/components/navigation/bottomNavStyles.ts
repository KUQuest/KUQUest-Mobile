...
const styles = {
  ...
  tabletBar:
    "flex-1 flex-col items-stretch justify-center gap-[8px] px-[4px] py-[8px] pt-[8px]",
  ...
  label:
    "text-ku-text-secondary text-ku-label font-ku-semibold mt-[2px] text-center max-w-full",
  createItem: "px-[4px]",
  ...
  unreadBadge:
    "bg-ku-danger-icon border-ku-surface rounded-[7px] border-2 h-[14px] absolute right-[24px] top-[9px] w-[14px]",
} as const;
