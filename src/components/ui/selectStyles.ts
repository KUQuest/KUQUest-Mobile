const styles = {
  ...
  selectBox:
    "flex-row justify-between items-center border border-ku-border-muted rounded-[10px] px-[12px] py-[10px] bg-ku-card min-h-[48px]",
  ...
  modalHandle:
    "self-center w-[36px] h-[4px] rounded-[2px] bg-ku-border-muted mt-[10px]",
  modalHeader:
    "flex-row justify-between items-center px-[20px] pt-[20px] pb-[12px] border-b border-b-ku-border-muted",
  ...
  searchContainer:
    "flex-row items-center mx-[20px] my-[12px] px-[8px] border border-ku-border-muted rounded-[10px] bg-ku-surface-subtle min-h-[48px]",
  ...
  dropdownSearchContainer: "mx-[12px] my-[10px]",
  searchInput:
    "flex-1 px-[8px] py-[8px] font-ku-regular text-ku-body-small text-ku-text-strong",
  optionItem:
    "flex-row justify-between items-center min-h-[52px] py-[14px] px-[20px] border-b border-b-ku-surface-muted",
  optionText: "font-ku-regular text-ku-body text-ku-text-secondary",
  optionTextSelected: "font-ku-bold text-ku-primary",
  emptyText:
    "p-[24px] text-center font-ku-regular text-ku-body-small text-ku-text-muted",
} as const;
