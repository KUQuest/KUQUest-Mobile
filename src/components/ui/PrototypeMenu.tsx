  ...
  return (
    <>
      ...
      >
        ...
        {!compact ? (
          <Text className={styles.triggerText}>{messages.openMenu}</Text>
        ) : null}
      </Pressable>
            ...
            >
              <View className={cn(styles.section, styles.sectionFirst)}>
                ...
                <Text className={styles.sectionHint}>
                  ...
                  {labelFor(
                    PROTOTYPE_PERSONAS.find(
                      (persona) => persona.id === activePersonaId
                    )?.label ?? PROTOTYPE_PERSONAS[0].label,
                    locale
                  )}
                </Text>
                    ...
                    return (
                      ...
                      >
                        ...
                        <View className={styles.optionCopy}>
                          ...
                          <Text className={styles.optionRoute}>
                            {persona.id}
                          </Text>
                        </View>
                      </Pressable>
...
function ResetButton({
  ...
  return (
    ...
    >
      <Text
        className={cn(styles.resetOptionText, all && styles.resetOptionTextAll)}
      >
        {label}
      </Text>
    </Pressable>
