...
export const prototypeQuestTagMessages: Record<
  SupportedLocale,
...
> = {
  ...
  th: {
    ...
    "campus-life": "ชีวิตในมหาวิทยาลัย",
  },
};

export const prototypeQuestMessages: Record<
  SupportedLocale,
...
> = {
  ...
  th: {
    ...
    "move-club-equipment": {
      ...
      tags: ["ยกของ"],
      description: "ย้ายอุปกรณ์สำหรับกิจกรรมจากห้องเก็บของไปยังห้องจัดกิจกรรม",
    ...
    "deliver-drinks": {
      ...
      tags: ["ส่งของ"],
      description: "ซื้อเครื่องดื่มและนำไปส่งให้กลุ่มที่อ่านหนังสือในห้องสมุด",
