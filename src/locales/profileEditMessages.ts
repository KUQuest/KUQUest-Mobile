...
export const profileEditMessages: Record<SupportedLocale, ProfileEditMessages> =
  {
    en: {
      ...
      bio: "About you",
      bioPlaceholder:
        "Share your background, skills, or the Quests you are looking for...",
      avatar: "Profile image",
      image: "Image",
      changeAvatar: "Change profile photo",
      avatarHelp: "JPG, PNG, or WebP · max 5 MB",
      avatarPreviewError:
        "We could not load this photo. Choose a new one to replace it.",
      avatarUploadError:
        "Your profile details were saved, but the photo could not be uploaded. Try saving the photo again.",
      titleLabel: "Title",
    ...
    th: {
      ...
      saveError:
        "ไม่สามารถบันทึกโปรไฟล์ได้ การเปลี่ยนแปลงของคุณยังอยู่ กรุณาลองอีกครั้ง",
      ...
      experienceFormHint:
        "เพิ่มตำแหน่ง โครงการ หรือกิจกรรม เพื่อแสดงประสบการณ์ของคุณบนโปรไฟล์สาธารณะ",
      ...
      deleteMessage: (title) =>
        `ต้องการลบ “${title}” หรือไม่ การกระทำนี้ย้อนกลับไม่ได้`,
      confirmDelete: "ลบ",
      name: "ชื่อที่แสดง",
      ...
      avatarPreviewError:
        "ไม่สามารถโหลดรูปนี้ได้ กรุณาเลือกรูปใหม่เพื่อแทนที่รูปเดิม",
      avatarUploadError:
        "บันทึกข้อมูลโปรไฟล์แล้ว แต่ไม่สามารถอัปโหลดรูปได้ กรุณากดบันทึกอีกครั้ง",
