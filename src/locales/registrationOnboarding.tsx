...
export const onboardingMessages = {
  th: {
    ...
    aboutYourselfSub: 'เพิ่มคำแนะนำสั้น ๆ เพื่อให้ผู้สร้างเควสรู้จักคุณมากขึ้น',
...
ข้อมูลทั้งหมดจะถูกเก็บรักษาอย่างปลอดภัยตาม พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล (PDPA) และจะไม่ถูกนำไปเปิดเผยแก่บุคคลภายนอกโดยไม่ได้รับอนุญาต`,
    ...
    step3Desc: 'เพิ่มใบรับรอง ประสบการณ์ และผลงานเพื่อช่วยให้ผู้สร้างเควสเข้าใจทักษะของคุณมากขึ้น',
    certification: 'ใบรับรอง (ไม่บังคับ)',
    ...
    optionalEmpty: 'ยังไม่มีรายการ เพิ่มได้เมื่อคุณพร้อม',
