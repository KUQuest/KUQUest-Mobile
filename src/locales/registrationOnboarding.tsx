export const onboardingMessages = {
  th: {
    ...
    aboutYourselfSub:
      "เขียนแนะนำตัวสั้น ๆ เพื่อให้ผู้สร้างเควสรู้จักคุณมากขึ้น",
    descriptionLabel: "ข้อความแนะนำตัว (ไม่บังคับ)",
    descriptionPlaceholder:
      "คุณมีทักษะอะไรบ้าง? เควสประเภทไหนที่คุณกำลังตามหา? แชร์ประวัติหรือประสบการณ์ของคุณให้เราทราบ...",
    skip: "ข้าม (Skip)",
    ...
    privacySummary:
      "เราเก็บและใช้ข้อมูลที่จำเป็นเพื่อให้ KUQuest ทำงานได้อย่างปลอดภัย และปกป้องข้อมูลของคุณตามกฎหมายคุ้มครองข้อมูลส่วนบุคคล",
...
ข้อมูลทั้งหมดจะถูกเก็บรักษาอย่างปลอดภัยตาม พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล (PDPA) และจะไม่ถูกนำไปเปิดเผยแก่บุคคลภายนอกโดยไม่ได้รับอนุญาต`,
    ...
    step3Desc:
      "เพิ่มเกียรติบัตร ประวัติการทำงาน และตัวอย่างผลงาน เพื่อช่วยให้ผู้สร้างเควสเข้าใจทักษะของคุณมากขึ้น",
    certification: "เกียรติบัตร (ไม่บังคับ)",
    certDesc:
      "อัปโหลดเกียรติบัตรที่เคยได้รับ เพื่อเพิ่มความน่าเชื่อถือให้โปรไฟล์ของคุณ",
    certName: "ชื่อเกียรติบัตร",
    certIssuer: "ผู้ออก / หน่วยงานจัดกิจกรรม",
    certIssuedAt: "วันที่ออก",
    selectDate: "เลือกวันที่",
    detailProject:
      "อธิบายรายละเอียดของผลงาน หน้าที่ของคุณ หรือความสำเร็จที่ได้รับ...",
    addMoreCert: "+ เพิ่มเกียรติบัตร",
    experience: "ประวัติการทำงาน / กิจกรรม (ไม่บังคับ)",
    expDesc:
      "บอกเล่าประสบการณ์หรือกิจกรรมที่คุณเคยทำ เพื่อแสดงให้เห็นถึงความสามารถของคุณ",
    ...
    experienceDescriptionPlaceholder:
      "เล่าให้ฟังหน่อยว่าคุณทำหน้าที่อะไรบ้าง หรือได้ทักษะอะไรจากกิจกรรมนี้...",
    ...
    fileTooLargeDesc:
      "ไฟล์ที่คุณพยายามอัปโหลดมีขนาดเกิน 5MB กรุณาบีบอัดไฟล์หรือเลือกไฟล์ที่ขนาดเล็กกว่าแล้วลองใหม่อีกครั้ง",
  ...
  en: {
    ...
    aboutYourselfSub:
      "Add a short introduction so Quest creators know you better.",
    descriptionLabel: "Description about yourself (Optional)",
    descriptionPlaceholder:
      "What are your skills? What kind of quests are you looking for? Share your background or experience...",
    skip: "Skip",
    ...
    privacySummary:
      "We collect and use only the information needed to keep KUQuest useful and secure, protecting your data under applicable privacy laws.",
...
Your data will be stored securely in accordance with applicable Personal Data Protection Acts (PDPA) and will not be shared with third parties without your consent.`,
    ...
    step3Desc:
      "Add certificates, experience, and work samples to help Quest creators understand your skills.",
    ...
    detailProject:
      "Detail your relevant project work, academic achievements, or professional background...",
    addMoreCert: "+ Add another certificate",
    experience: "Experience (Optional)",
    expDesc:
      "Share your past experiences or activities to highlight your capabilities.",
    jobTitle: "Job title",
    ...
    experienceDescriptionPlaceholder:
      "Describe your responsibilities, achievements, or skills gained from this experience...",
    ...
    fileTooLargeDesc:
      "The file you are trying to upload exceeds the 5MB limit. Please compress your file or choose a smaller one and try again.",
    tryAgain: "Try again",
    backBtn: "Back",
    submitting: "Saving...",
