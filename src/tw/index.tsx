...
export const ActivityIndicator = (
  ...
  return useCssElementCompat(RNActivityIndicator, props, {
    className: "style",
  });
};
...
export const KeyboardAvoidingView = (
  ...
  return useCssElementCompat(RNKeyboardAvoidingView, props, {
    className: "style",
  });
};
...
type CssTouchableHighlightProps = React.ComponentProps<
...
function CSSTouchableHighlight({
  ...
  return (
    <RNTouchableHighlight
      ...
      style={
        style as React.ComponentProps<typeof RNTouchableHighlight>["style"]
      }
    />
  );
}
