...
const nonBlank = (maximum: number) =>
  z.string().min(1).max(maximum).regex(/\S/);
...
export const questApiV1ProofReviewStatusSchema = z.enum([
  "PROOF_APPROVED",
  "PROOF_REJECTED",
]);
...
export const questApiV1TagSchema = z
  .object({
...
export const questApiV1LocationSchema = z
  .object({
...
export const questApiV1LocationInputSchema = z
  .object({
    label: nullableOptional(z.string().max(100).regex(/\S/)),
  })
  .strict();

export const questApiV1ImageSchema = z
  .object({
...
export const questApiV1QuestBoardItemSchema = z
  .object({
    id: questApiV1IdSchema,
    title: z.string(),
...
export const questApiV1QuestMineItemSchema =
  questApiV1QuestBoardItemSchema.extend({
    questStatus: questApiV1QuestStatusSchema,
  });

export const questApiV1QuestDetailSchema = z
  .object({
    id: questApiV1IdSchema,
    title: z.string(),
...
export const questApiV1ReasonSchema = z
  .object({
    code: z.string(),
    message: z.string(),
  })
...
export const questApiV1PublishCheckSchema = z
  .object({
...
export const questApiV1ApplicationSchema = z
  .object({
    id: questApiV1IdSchema,
...
export const questApiV1AssignmentSchema = z
  .object({
    id: questApiV1IdSchema,
    questId: questApiV1IdSchema,
    workerId: questApiV1IdSchema,
...
export const questApiV1TeamMemberSchema = z
  .object({
...
export const questApiV1TeamSchema = z
  .object({
    id: questApiV1IdSchema,
    questId: questApiV1IdSchema,
...
export const questApiV1InvitationSchema = z
  .object({
    id: questApiV1IdSchema,
...
export const questApiV1ProofSchema = z
  .object({
    id: questApiV1IdSchema,
    questId: questApiV1IdSchema,
...
export const questApiV1EditResponseSchema = z
  .object({
    userId: questApiV1IdSchema,
...
export const questApiV1EditRequestSchema = z
  .object({
    id: questApiV1IdSchema,
    questId: questApiV1IdSchema,
...
export const questApiV1CreateQuestRequestSchema = z
  .object({
    title: nonBlank(120),
...
export const questApiV1EditQuestRequestSchema = z
  .object({
...
export const questApiV1CreateApplicationRequestSchema = z
  .object({
    reworkLimit: questApiV1NonNegativeIntegerSchema.optional(),
  })
  .strict();

export const questApiV1CreateTeamRequestSchema = z
  .object({
    name: nonBlank(100),
    reworkLimit: questApiV1NonNegativeIntegerSchema.optional(),
  })
...
export const questApiV1UpdateTeamRequestSchema = z
  .object({
...
export const questApiV1CreateInvitationRequestSchema = z
  .object({
    invitedUserId: questApiV1IdSchema,
  })
  .strict();

export const questApiV1SubmitProofJsonRequestSchema = z
  .object({
...
export const questApiV1ReviewProofRequestSchema = z
  .object({
...
export const questApiV1CreateEditRequestSchema = z
  .object({
    title: nonBlank(120).optional(),
    description: nullableOptional(nonBlank(1000)),
    condition: nonBlank(1000).optional(),
...
export const questApiV1RespondEditRequestSchema = z
  .object({
    decision: questApiV1EditResponseDecisionSchema,
  })
  .strict();

export const questApiV1BoardQuerySchema = z
  .object({
...
export const questApiV1MineQuerySchema = z
  .object({
    limit: integerLikeSchema(1, 50).optional(),
    cursor: z.string().optional(),
  })
...
export const questApiV1SuccessResponseSchema = z
  .object({ success: z.literal(true) })
  .passthrough();
export const questApiV1ErrorResponseSchema = z
  .object({
...
export const questApiV1CreateQuestResponseSchema = successEnvelope(
  z.object({ id: questApiV1IdSchema }).passthrough()
);
export const questApiV1QuestBoardResponseSchema = successEnvelope(
  z
    .object({
...
export const questApiV1QuestMineResponseSchema = successEnvelope(
  z
    .object({
...
export const questApiV1QuestDetailResponseSchema = successEnvelope(
  questApiV1QuestDetailSchema
);
export const questApiV1PublishCheckResponseSchema = successEnvelope(
  questApiV1PublishCheckSchema
);
export const questApiV1ApplicationResponseSchema = successEnvelope(
  questApiV1ApplicationSchema
);
export const questApiV1ApplicationsResponseSchema = successEnvelope(
  z
    .object({
...
export const questApiV1SelectionResponseSchema = successEnvelope(
  z
    .object({
...
export const questApiV1TeamResponseSchema =
  successEnvelope(questApiV1TeamSchema);
export const questApiV1TeamsResponseSchema = successEnvelope(
  z
    .object({
...
export const questApiV1TeamMembersResponseSchema = successEnvelope(
  z
    .object({
...
export const questApiV1InvitationResponseSchema = successEnvelope(
  questApiV1InvitationSchema
);
export const questApiV1InvitationsResponseSchema = successEnvelope(
  z
    .object({
...
export const questApiV1ProofResponseSchema = successEnvelope(
  questApiV1ProofSchema
);
export const questApiV1ProofsResponseSchema = successEnvelope(
  z
    .object({
...
export const questApiV1ConfirmWorkResponseSchema = successEnvelope(
  z
    .object({
      confirmed: z.boolean(),
...
export const questApiV1ReviewProofResponseSchema = successEnvelope(
  z
    .object({
...
export const questApiV1CreateEditRequestResponseSchema = successEnvelope(
  z
    .object({
      status: z.string(),
...
export const questApiV1EditRequestResponseSchema = successEnvelope(
  questApiV1EditRequestSchema
);
export const questApiV1RespondEditRequestResponseSchema = successEnvelope(
  z
    .object({
      status: z.string(),
      requestId: questApiV1IdSchema,
...
export const questApiV1CancelResponseSchema = successEnvelope(
  z
    .object({
...
export type QuestApiV1Participation = z.infer<
  typeof questApiV1ParticipationSchema
>;
export type QuestApiV1QuestStatus = z.infer<typeof questApiV1QuestStatusSchema>;
export type QuestApiV1ApplicationStatus = z.infer<
  typeof questApiV1ApplicationStatusSchema
>;
export type QuestApiV1AssignmentStatus = z.infer<
  typeof questApiV1AssignmentStatusSchema
>;
export type QuestApiV1TeamStatus = z.infer<typeof questApiV1TeamStatusSchema>;
export type QuestApiV1InvitationStatus = z.infer<
  typeof questApiV1InvitationStatusSchema
>;
export type QuestApiV1ProofStatus = z.infer<typeof questApiV1ProofStatusSchema>;
export type QuestApiV1QuestBoardItem = z.infer<
  typeof questApiV1QuestBoardItemSchema
>;
export type QuestApiV1QuestMineItem = z.infer<
  typeof questApiV1QuestMineItemSchema
>;
export type QuestApiV1QuestDetail = z.infer<typeof questApiV1QuestDetailSchema>;
export type QuestApiV1PublishCheck = z.infer<
  typeof questApiV1PublishCheckSchema
>;
...
export type QuestApiV1CreateQuestInput = z.infer<
  typeof questApiV1CreateQuestRequestSchema
>;
export type QuestApiV1EditQuestInput = z.infer<
  typeof questApiV1EditQuestRequestSchema
>;
export type QuestApiV1CreateApplicationInput = z.infer<
  typeof questApiV1CreateApplicationRequestSchema
>;
export type QuestApiV1CreateTeamInput = z.infer<
  typeof questApiV1CreateTeamRequestSchema
>;
export type QuestApiV1UpdateTeamInput = z.infer<
  typeof questApiV1UpdateTeamRequestSchema
>;
export type QuestApiV1CreateInvitationInput = z.infer<
  typeof questApiV1CreateInvitationRequestSchema
>;
export type QuestApiV1SubmitProofJsonInput = z.infer<
  typeof questApiV1SubmitProofJsonRequestSchema
>;
export type QuestApiV1ReviewProofInput = z.infer<
  typeof questApiV1ReviewProofRequestSchema
>;
export type QuestApiV1CreateEditRequestInput = z.infer<
  typeof questApiV1CreateEditRequestSchema
>;
export type QuestApiV1RespondEditRequestInput = z.infer<
  typeof questApiV1RespondEditRequestSchema
>;
...
export const questPublishCheckResponseSchema =
  questApiV1PublishCheckResponseSchema;
export const questApplicationSchema = questApiV1ApplicationSchema;
export const questApplicationResponseSchema =
  questApiV1ApplicationResponseSchema;
export const questApplicationsResponseSchema =
  questApiV1ApplicationsResponseSchema;
...
export const questTeamMembersResponseSchema =
  questApiV1TeamMembersResponseSchema;
...
export const questInvitationsResponseSchema =
  questApiV1InvitationsResponseSchema;
...
export const questEditRequestResponseSchema =
  questApiV1EditRequestResponseSchema;
