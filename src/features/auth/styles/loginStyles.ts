const styles = {
  ...
  subtitle:
    "font-ku-semibold text-ku-label font-ku-semibold text-ku-text-muted tracking-[2.5px] text-left uppercase mt-[6px]",
  formSection: "w-full gap-[16px] mt-[64px]",
  noticeCard:
    "bg-ku-surface-success border-ku-border-success border rounded-[16px] p-[16px] flex-row items-center gap-[12px] mb-[4px]",
  noticeText:
  ...
  errorCard:
    "bg-ku-surface-danger border-ku-border-danger border rounded-[16px] p-[16px] flex-row items-start gap-[12px] mb-[4px]",
