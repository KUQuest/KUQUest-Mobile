const styles = {
  ...
  title: 'font-ku-bold text-[44px] font-extrabold text-ku-primary -tracking-[0.5px] text-left',
  subtitle: 'font-ku-semibold text-[12px] font-semibold text-ku-text-muted tracking-[2.5px] text-left uppercase mt-[6px]',
  ...
  noticeText: 'flex-1 font-ku-regular text-[14px] text-ku-text-secondary leading-[20px]',
  ...
  errorText: 'font-ku-medium text-[14px] text-ku-danger-dark leading-[20px] font-medium',
  retryButton: 'self-start bg-ku-danger-dark px-[16px] py-[8px] rounded-[8px]',
  retryButtonText: 'font-ku-bold text-ku-white text-[13px] font-bold',
  ...
  footerLinkText: 'font-ku-medium text-[13px] font-medium text-ku-text-muted',
  copyrightText: 'font-ku-regular text-[12px] text-ku-text-faint text-left',
} as const;
