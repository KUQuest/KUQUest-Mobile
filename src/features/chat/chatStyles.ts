const styles = {
  ...
  searchField:
    "items-center bg-ku-surface border-ku-border-accent rounded-[18px] border flex-row min-h-[56px] px-[12px] mt-[8px]",
  searchIcon: "items-center justify-center h-[40px] w-[40px]",
  searchInput:
    "text-ku-text-strong flex-1 font-ku-regular text-ku-body min-h-[52px] px-[8px]",
  ...
  loadErrorState:
    "items-center bg-ku-surface-danger border-ku-border-danger rounded-[16px] border gap-[8px] min-h-[180px] justify-center px-[24px] py-[28px]",
  loadErrorTitle:
  ...
  identityRow:
    "items-center flex-row min-h-[72px] px-[16px] pb-[12px] pt-[4px]",
  ...
  readOnlyBanner:
    "bg-ku-surface-muted border-ku-border-subtle rounded-[14px] border mx-[24px] mt-[12px] px-[12px] py-[10px]",
  readOnlyBannerTitle:
  ...
  compactSearchField:
    "items-center bg-ku-surface border-ku-border-accent rounded-[18px] border flex-row min-h-[52px] px-[8px]",
  compactSearchInput:
  ...
  resultMeta:
    "text-ku-text-muted font-ku-medium text-ku-label px-[24px] pt-[12px]",
  messageContent: "px-[24px] pt-[20px]",
  dateSeparator:
    "self-center bg-ku-surface-muted rounded-ku-pill px-[10px] py-[5px]",
  dateText: "text-ku-text-muted font-ku-medium text-ku-caption",
  messageRow: "items-end flex-row mt-[16px]",
  messageRowMe: "justify-end",
  messageAvatar:
    "items-center rounded-ku-pill h-[32px] justify-center mr-[8px] w-[32px]",
  ...
  messageMeta:
    "text-ku-text-muted font-ku-regular text-ku-caption mt-[4px] px-[4px]",
  attachmentBubble:
    "items-center bg-ku-success-light rounded-[18px] flex-row min-h-[60px] mt-[4px] px-[10px] py-[8px]",
  ...
  composerWrap:
    "bg-ku-background border-ku-border-subtle border-t px-[16px] pb-[8px] pt-[8px]",
  composer:
    "items-center bg-ku-surface-muted rounded-[24px] flex-row min-h-[56px] px-[6px]",
  composerButton:
