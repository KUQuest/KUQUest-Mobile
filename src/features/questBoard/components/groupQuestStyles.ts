const styles = {
  ...
  notice:
    "bg-ku-surface-accent border-ku-border-accent rounded-[14px] border flex-row items-start px-[12px] py-[11px]",
  ...
  searchField:
    "items-center bg-ku-surface border-ku-border rounded-[18px] border flex-row min-h-[56px] px-[14px] mt-[8px]",
  searchInput:
    "text-ku-text-strong flex-1 font-ku-regular text-ku-body ml-[9px] min-h-[52px]",
  searchClear:
    "items-center rounded-ku-pill h-[44px] justify-center ml-[4px] w-[44px]",
  memberList: "gap-[8px] mt-[10px]",
  memberRow:
    "bg-ku-surface-muted border-ku-border-subtle border rounded-[14px] flex-row items-center min-h-[64px] px-[10px] py-[7px]",
  ...
  memberAvatar:
    "items-center bg-ku-surface-success rounded-ku-pill h-[40px] justify-center ml-[9px] w-[40px]",
  ...
  memberInvite:
    "items-center border-ku-primary rounded-ku-pill border min-h-[44px] justify-center ml-[8px] px-[11px]",
  memberInviteText: "text-ku-primary font-ku-semibold text-ku-label",
  bulkInviteBar:
    "items-center bg-ku-surface-accent border-ku-border-accent border rounded-[14px] flex-row mt-[10px] px-[12px] py-[8px]",
  ...
  emptyIcon:
    "items-center bg-ku-surface-success rounded-ku-pill h-[52px] justify-center mb-[10px] w-[52px]",
  ...
  invitationRow:
    "bg-ku-surface-muted border-ku-border-subtle border rounded-[14px] px-[12px] py-[10px]",
  ...
  invitationStatus:
    "text-ku-text-secondary font-ku-regular text-ku-label mt-[2px]",
  invitationExpiry: "text-ku-text-muted font-ku-regular text-ku-label mt-[1px]",
  invitationActions: "flex-row gap-[8px] mt-[8px]",
  invitationAction:
    "items-center border-ku-primary rounded-ku-pill border flex-1 min-h-[44px] justify-center px-[8px]",
  ...
  settlement:
    "bg-ku-surface border-ku-border-subtle border rounded-[16px] mt-[12px] p-[12px]",
  ...
  proposalRow:
    "bg-ku-surface-muted border-ku-border-subtle border rounded-[16px] p-[12px]",
  ...
  proposalRowStatus:
    "items-center border rounded-ku-pill flex-row min-h-[28px] px-[8px]",
  proposalRowStatusText: "font-ku-semibold text-ku-label",
  proposalSelect: "items-start flex-row min-h-[48px]",
  proposalSelectionBox:
    "items-center border-ku-border-accent border rounded-ku-pill h-[24px] justify-center mt-[1px] w-[24px]",
  ...
  consentStatusDescription:
    "text-ku-text-secondary font-ku-regular text-ku-body-small mt-[3px]",
  countdownCard:
    "items-center bg-ku-card border-ku-border-accent border rounded-[14px] flex-row justify-between mt-[12px] px-[12px] py-[10px]",
  ...
  voterRow:
    "items-center bg-ku-surface border-ku-border-subtle border rounded-[12px] flex-row min-h-[52px] px-[10px]",
  voterAvatar:
    "items-center bg-ku-surface-success rounded-ku-pill h-[32px] justify-center w-[32px]",
  ...
  consentAction:
    "items-center border rounded-ku-pill flex-1 min-h-[52px] justify-center px-[10px]",
  ...
  chatHintText:
    "text-ku-text-secondary flex-1 font-ku-regular text-ku-label ml-[8px]",
} as const;
