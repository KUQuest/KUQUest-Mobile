import { assignment, createDraftState, makeTeam, proof } from "./questSeeds";
import {
...
import { addMilliseconds, clone } from "../domain/questStateUtils";
import {
...
export type QuestReducerAction =
  ...
  | {
      ...
      questId: string;
      leaderId?: string;
      /** Deprecated: team names are ignored. */
      name?: string;
    }
  | {
      type: "INVITE_WORKER";
