const styles = {
  ...
  canonicalStatus: "text-ku-primary font-ku-semibold text-ku-label mt-[4px]",
  ...
  creatorValue:
    "text-ku-text-strong font-ku-medium text-ku-body-small mt-[1px]",
  ...
  questImageFallbackText:
    "text-ku-text-muted font-ku-regular text-ku-label text-center mt-[4px]",
  heroCard:
    "bg-ku-surface-accent border-ku-border-accent rounded-[18px] border mt-[20px] p-[16px]",
  ...
  scheduleDescription:
    "text-ku-text-secondary font-ku-regular text-ku-label mt-[1px]",
  ...
  timelineDescription:
    "text-ku-text-secondary font-ku-regular text-ku-label mt-[6px]",
  section: "mt-[32px]",
  ...
  descriptionCard:
    "bg-ku-surface border-ku-border-subtle rounded-[14px] border p-[16px]",
  requirementCard:
    "bg-ku-surface border-ku-border-subtle rounded-[14px] border gap-[10px] p-[12px]",
  requirementRow:
    "items-start bg-ku-surface-accent rounded-[12px] flex-row p-[12px]",
  requirementIcon:
  ...
  requirementDescription:
    "text-ku-text-secondary font-ku-regular text-ku-meta mt-[2px]",
  confirmHeader: "items-center flex-row justify-between",
  sheetCloseButton:
    "items-center rounded-ku-pill h-[44px] justify-center ml-[8px] w-[44px] active:bg-ku-surface-muted",
  statusCard:
    "items-center bg-ku-surface-success border-ku-border-success rounded-[16px] border mt-[24px] p-[16px]",
  ...
  prototypeHeader: "items-center flex-row gap-[8px]",
  prototypeTitle: "text-ku-text-strong flex-1 font-ku-bold text-ku-body",
  prototypeStatus: "text-ku-primary font-ku-semibold text-ku-label mt-[4px]",
  prototypeCopy:
    "text-ku-text-secondary font-ku-regular text-ku-body-small mt-[6px]",
  prototypeMeta: "text-ku-text-muted font-ku-medium text-ku-label mt-[6px]",
  prototypeActions: "flex-row flex-wrap gap-[8px] mt-[12px]",
  prototypeAction:
  ...
  prototypeList: "gap-[6px] mt-[8px]",
  prototypeListItem: "text-ku-text-secondary font-ku-regular text-ku-label",
  actionBar:
    "bg-ku-background border-t-ku-border-subtle border-t bottom-0 left-0 p-[16px] absolute right-0",
  actionRow: "flex-row gap-[8px]",
  messageOwnerAction:
  ...
  confirmSummary:
    "bg-ku-surface-accent rounded-[14px] gap-[6px] mt-[16px] p-[16px]",
