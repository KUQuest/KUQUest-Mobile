const styles = {
  ...
  boardIntroActions: "items-center flex-row ml-[8px]",
  roleplayShortcut:
    "items-center bg-ku-surface-accent border-ku-border-accent border min-h-[44px] justify-center mr-[8px] px-[10px] rounded-ku-pill",
  roleplayShortcutText: "font-ku-semibold text-ku-label text-ku-primary",
  boardIntroCopy: "flex-1 min-w-0 pr-[8px]",
  ...
  searchField:
    "items-center bg-ku-surface border-ku-border-accent rounded-[18px] border flex-row min-h-[56px] px-[16px]",
  searchInput:
    "text-ku-text-strong flex-1 font-ku-regular text-ku-body min-h-[54px] px-[8px]",
  iconButton: "items-center h-[48px] justify-center w-[48px]",
  toolbar: "items-center flex-row justify-between mt-[16px]",
  toolbarButton:
    "items-center rounded-ku-pill flex-row min-h-[48px] px-[8px] py-[4px] active:bg-ku-surface-muted",
  ...
  filterCount:
    "items-center bg-ku-primary rounded-ku-pill h-[20px] justify-center ml-[4px] min-w-[20px] px-[5px]",
  ...
  cardCategory:
    "items-center bg-ku-surface-accent rounded-ku-pill flex-row self-start min-h-[32px] mt-[8px] px-[8px]",
  cardCategoryText: "text-ku-primary font-ku-medium text-ku-label ml-[4px]",
  rewardBlock:
    "bg-ku-surface-success border-ku-border-success rounded-[14px] border shrink-0 min-w-[88px] px-[10px] py-[8px]",
  ...
  infoText:
    "text-ku-text-secondary font-ku-regular text-ku-body-small ml-[8px]",
  infoTextPrimary: "text-ku-text-strong font-ku-medium",
  infoTextFlexible: "flex-1 min-w-0",
  participantCount:
    "items-center bg-ku-surface-accent rounded-[12px] justify-center min-h-[32px] min-w-[48px] ml-[8px] px-[8px]",
  participantCountText: "text-ku-primary font-ku-medium text-ku-body-small",
  spotsLeftText:
    "text-ku-success flex-1 font-ku-medium text-ku-label ml-[8px] text-right",
  locationContent: "flex-1 min-w-0 ml-[8px]",
  locationText:
    "text-ku-text-strong font-ku-regular text-ku-body-small min-w-0",
  cardFooter:
    "items-center border-ku-border-subtle border-t flex-row justify-end mt-[12px] pt-[12px]",
  cardAccessibilityMeta: "absolute h-0 opacity-0 w-0",
  retryStatus:
    "text-ku-success font-ku-medium text-ku-meta text-center mt-[8px]",
  ...
  sheetScroll: "flex-1",
  sheetHandle:
    "self-center bg-ku-border rounded-ku-pill h-[4px] mb-[16px] w-[42px]",
  ...
  sheetCloseButton:
    "items-center rounded-ku-pill h-[48px] justify-center ml-[8px] w-[48px] active:bg-ku-surface-muted",
  sheetScrollContent: "pb-[8px]",
  sheetSection: "mb-[16px]",
  sheetSectionTitle:
    "text-ku-text-secondary font-ku-semibold text-ku-meta mb-[4px]",
  selectedTags: "flex-row flex-wrap gap-[4px] mb-[8px]",
  selectedTag:
    "items-center bg-ku-surface-success border-ku-border-success rounded-ku-pill border flex-row min-h-[48px] px-[10px]",
  selectedTagText: "text-ku-success font-ku-medium text-ku-label mr-[4px]",
  tagSearchField:
    "items-center bg-ku-surface border-ku-border-muted rounded-[8px] border flex-row min-h-[48px] px-[12px]",
  tagSearchInput:
  ...
  option:
    "bg-ku-surface border-ku-border rounded-ku-pill border min-h-[48px] justify-center px-[16px] active:bg-ku-surface-muted",
  ...
  rewardInput:
    "bg-ku-surface border-ku-border-muted rounded-[8px] border font-ku-regular text-ku-text-strong min-h-[48px] px-[12px]",
  ...
  secondaryAction:
    "items-center border-ku-border rounded-ku-pill border flex-[0.9] justify-center min-h-[48px] px-[8px]",
  secondaryActionText: "text-ku-text-strong font-ku-semibold text-ku-meta",
  primaryAction:
    "items-center bg-ku-primary rounded-ku-pill flex-[1.4] justify-center min-h-[48px] px-[8px]",
