const styles = {
  ...
  personaOption:
    "bg-ku-surface-muted border-ku-border-subtle rounded-[14px] border flex-row items-center min-h-[60px] px-[12px] py-[8px]",
  personaOptionSelected: "bg-ku-surface-success border-ku-border-success",
  personaOptionCopy: "flex-1 min-w-0 pr-[12px]",
  personaOptionLabel:
  ...
  actionButtonCompact: "flex-1 justify-center min-h-[46px] px-[12px]",
  ...
  actionCopyCompact: "flex-none ml-[7px]",
