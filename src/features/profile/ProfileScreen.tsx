...
import { TopBar } from '../../components/ui/AppPrimitives';
import { SupportedLocale, useLocale } from '../../locales/LocaleProvider';
import {
  ProfileData,
  ProfileHeader,
  ProfileReviews,
...
const translations: Record<SupportedLocale, ProfileTranslation> = {
  en: {
    profileData: {
      name: 'Jane Doe',
