const styles = {
  ...
  statsCard:
    "self-stretch rounded-[16px] bg-ku-surface-success border-ku-border-success border p-[16px]",
  ...
  sectionNotice:
    "items-center bg-ku-surface-danger border-ku-border-danger rounded-[8px] border gap-[8px] mb-[16px] p-[8px]",
  sectionNoticeText:
  ...
  emptyAction:
    "min-h-[48px] justify-center rounded-ku-pill bg-ku-surface-accent border-ku-border-accent border px-[16px]",
  ...
  ratingDistributionRow:
    "items-center flex-row gap-[8px] mt-[4px] min-h-[44px]",
  ...
  tabList:
    "bg-ku-surface border-ku-border-accent rounded-[16px] border flex-row px-[4px]",
  ...
  tabText:
    "text-ku-text-secondary font-ku-semibold text-ku-label mt-[4px] text-center",
  tabTextSelected: "text-ku-primary",
  experience:
    "flex-row border-l-[2px] border-l-ku-border-subtle pl-[20px] pb-[20px]",
  timelineIcon:
    "items-center bg-ku-card h-[22px] justify-center -ml-[31px] mr-[10px] w-[22px]",
  ...
  previewCard:
    "items-center bg-ku-card rounded-[16px] max-h-[90%] p-[16px] w-full",
  previewClose:
    "self-end min-h-[48px] min-w-[48px] items-center justify-center",
  previewScroll: "max-w-full w-full",
  previewImage: "max-w-full w-full",
  previewTitle:
    "text-ku-text font-ku-semibold text-ku-body mt-[8px] text-center",
  grid: "gap-[16px]",
  gridRow: "flex-row gap-[16px]",
  gridSpacer: "flex-1",
  certificateCard: "flex-1 min-w-0",
  certificateImageFrame:
    "bg-ku-surface-placeholder border-ku-border-subtle rounded-[10px] border w-full items-center justify-center mb-[8px] overflow-hidden",
  ...
  reviewCount:
    "text-ku-text-muted font-ku-regular text-ku-caption mt-[4px] text-center",
  reviewTotalQuests:
    "text-ku-text-subtle font-ku-regular text-ku-caption mt-[2px] text-center",
