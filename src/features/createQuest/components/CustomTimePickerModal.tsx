...
export default function CustomTimePickerModal({
  ...
  const quickPresets = useMemo(() => {
    ...
    list.push({ label: messages.now, time: nowTime });
    ...
    if (
      ...
      list.push({ label: messages.in1h, time: `${hPlus1}:${smStr}` });
      list.push({ label: messages.in2h, time: `${hPlus2}:${smStr}` });
      list.push({ label: "+3 ชม.", time: `${hPlus3}:${smStr}` });
      list.push({ label: messages.endOfDay, time: "23:59" });
    } else {
      ...
      list.push({ label: messages.in1h, time: `${hPlus1}:${curMStr}` });
      list.push({ label: messages.in2h, time: `${hPlus2}:${curMStr}` });
