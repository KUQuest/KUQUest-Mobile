const styles = {
  ...
  autosaveStatus:
    "items-center flex-row min-h-[24px] gap-[6px] px-[4px] mt-[4px]",
  ...
  saveErrorCard:
    "bg-ku-surface-danger border-ku-border-danger rounded-[12px] border flex-row items-center mt-[12px] px-[12px] py-[10px]",
  ...
  validationSummary:
    "bg-ku-surface-danger border border-ku-border-danger rounded-[12px] flex-row items-start gap-[8px] px-[12px] py-[10px] mt-[12px]",
  validationIcon: "items-center justify-center mt-[1px]",
  validationSummaryText:
    "text-ku-danger-dark flex-1 font-ku-medium text-ku-meta",
  sectionCard:
    "bg-ku-card border-ku-border-subtle rounded-[16px] border mb-[16px] p-[20px]",
  setupCard:
    "bg-ku-surface-accent border-ku-border-accent rounded-[16px] border mb-[16px] p-[16px]",
  ...
  setupMetricValue:
    "text-ku-text-strong font-ku-bold text-ku-body-small mt-[1px] text-center",
  ...
  setupHint:
    "text-ku-text-secondary font-ku-regular text-ku-body-small mt-[12px]",
  ...
  sectionDescription:
    "text-ku-text-secondary font-ku-regular text-ku-meta mt-[3px]",
  ...
  collapsibleSummary:
    "text-ku-text-muted font-ku-regular text-ku-body-small mt-[3px]",
  ...
  dateField:
    "items-center bg-ku-card border-ku-border rounded-[12px] border flex-row justify-between min-h-[48px] px-[16px]",
  dateText:
    "text-ku-text-strong flex-1 font-ku-regular min-w-0 mr-[12px] text-ku-control",
  placeholderText: "text-ku-text-muted",
  inputWithIcon:
    "items-center bg-ku-card border-ku-border rounded-[12px] border flex-row min-h-[48px] px-[16px]",
  modalBackdrop: "bg-ku-overlay flex-1 justify-end",
  pickerSheet:
    "bg-ku-background rounded-tl-[24px] rounded-tr-[24px] px-[16px] pb-[24px] pt-[16px]",
  ...
  onlineToggle:
    "bg-ku-surface-subtle border-ku-border-subtle rounded-[12px] border flex-row items-center min-h-[64px] mb-[16px] p-[12px]",
  checkbox:
  ...
  proofToggleLabel:
    "text-ku-text-strong flex-1 font-ku-semibold text-ku-control ml-[10px]",
  proofDescription:
    "text-ku-text-secondary font-ku-regular text-ku-label ml-[34px] mt-[2px]",
  imagePicker:
    "items-center bg-ku-surface-accent border-ku-border-accent rounded-[12px] border-dashed border justify-center min-h-[128px] p-[16px]",
  imageTitle: "text-ku-primary font-ku-semibold text-ku-control mt-[8px]",
  changeImagesButton:
    "items-center min-h-[48px] justify-center mt-[8px] px-[12px]",
  ...
  choice:
    "items-center bg-ku-card border-2 border-ku-border-muted flex-row min-w-0 rounded-[14px] px-[12px]",
  ...
  choiceDescription:
    "text-ku-text-secondary font-ku-regular text-ku-body-small mt-[2px]",
  radio:
  ...
  modeSummary:
    "bg-ku-surface-accent rounded-[14px] flex-row mt-[14px] p-[12px]",
  modeIcon:
    "items-center bg-ku-surface-success rounded-ku-pill h-[48px] justify-center mr-[10px] w-[48px]",
  ...
  modeDescription:
    "text-ku-text-secondary font-ku-regular text-ku-body-small mt-[6px]",
  additionalSettings: "border-t-ku-border-subtle border-t mt-[24px] pt-[20px]",
  additionalSettingsTitle:
    "text-ku-text-strong font-ku-bold text-ku-subtitle mb-[16px]",
  currencyInput:
    "items-center bg-ku-card border-ku-border rounded-[12px] border flex-row min-h-[48px] px-[16px]",
  ...
  readOnlyField:
    "items-start bg-ku-surface-muted border-ku-border-muted rounded-[12px] border justify-center min-h-[48px] px-[12px]",
  readOnlyValue: "text-ku-text-strong font-ku-medium text-ku-body-small",
  singleHeadcountHint:
    "text-ku-text-muted font-ku-regular text-ku-label mt-[4px]",
  ...
  summaryRow:
    "border-b-ku-border-subtle border-b flex-row items-start py-[10px]",
  summaryLabel:
    "text-ku-text-muted flex-[0.36] font-ku-regular text-ku-meta mr-[10px]",
  summaryValue:
    "text-ku-text-strong flex-1 font-ku-medium text-ku-meta min-w-0",
  publishCheckCard:
    "bg-ku-surface-success border-ku-border-success rounded-[14px] border mt-[16px] p-[14px]",
  ...
  publishCheckStatus:
    "text-ku-primary font-ku-semibold text-ku-body-small mt-[3px]",
  ...
  publishCheckNote:
    "text-ku-text-secondary font-ku-regular text-ku-meta mt-[6px]",
  actionBar:
    "shadow-[0px_-4px_12px_rgb(18_32_24_/0.06)] items-center bg-ku-card border-t-ku-border-subtle border-t flex-row gap-[10px] px-[20px] pt-[12px] shrink-0",
  loadingActionBar:
    "items-center bg-ku-card border-t-ku-border-subtle border-t flex-row gap-[10px] px-[20px] pt-[12px] shrink-0",
  actionBarStacked: "items-stretch flex-col gap-[8px]",
  nextButtonFull: "w-full",
  reviewActionButton:
    "items-center h-[56px] justify-center min-h-[56px] rounded-[14px] px-[10px] py-[4px]",
  ...
  successIcon:
    "items-center bg-ku-surface-success border-ku-border-success rounded-ku-pill border h-[72px] justify-center mb-[24px] w-[72px]",
  successTitle: "text-ku-text-strong font-ku-bold text-ku-title text-center",
  successDescription:
    "text-ku-text-secondary font-ku-regular text-ku-body-small mt-[8px] max-w-[320px] text-center",
  fullButton: "mt-[16px]",
} as const;
