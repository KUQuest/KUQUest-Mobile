const styles = {
  ...
  modalContainer:
    "shadow-[0px_2px_5px_rgb(18_32_24_/0.18)] bg-ku-card rounded-[24px] p-[28px] w-full items-center",
  icon: "mb-[16px]",
  title:
    "font-ku-bold text-ku-section text-ku-text-strong mb-[12px] text-center",
  description:
