...
6. **Cross-cutting UI rules** (`docs/agents/ui-design-rules.md`): Authoritative for platform interaction, accessibility, adaptive layout, and native proof; `DESIGN.md` remains authoritative for visual identity and tokens.

## 4. Cross-cutting UI route

For any screen, component, form, sheet, animation, navigation, layout metric,
color token, or accessibility change, read [`ui-design-rules.md`](ui-design-rules.md)
